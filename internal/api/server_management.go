...
func (s *Server) registerManagementRoutes() {
	...
	mgmt.Use(s.managementAvailabilityMiddleware(), s.mgmt.Middleware())
	{
		...
		mgmt.PATCH("/client-api-keys", s.mgmt.PatchClientAPIKey)
		mgmt.DELETE("/client-api-keys", s.mgmt.DeleteClientAPIKey)
		...
		mgmt.GET("/traces/sessions/:session_id", s.mgmt.GetTraceSession)
		mgmt.DELETE("/traces/sessions/:session_id", s.mgmt.DeleteTraceSession)
		mgmt.GET("/traces/turns/:turn_id", s.mgmt.GetTraceTurn)
		mgmt.GET("/trace-settings", s.mgmt.GetTraceSettings)
		mgmt.PATCH("/trace-settings", s.mgmt.PatchTraceSettings)
